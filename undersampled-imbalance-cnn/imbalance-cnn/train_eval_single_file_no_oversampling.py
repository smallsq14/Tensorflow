...
for t in range(0,8):
    ...
    outfile = open('sf_noov_'+str(imbalance_size)+'_' + pos_or_neg + '_results_run_'+str(p)+'.txt', 'w')
    dbfieldname = 'sf_noov_'+str(imbalance_size)+'_' + pos_or_neg + '_results_run_'+str(p)
    ...
    p_length = len(list_positive_instances)
    n_length = len(list_negative_instances)
