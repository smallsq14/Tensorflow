...
for p in range(0,10):
    for t in range(0,6):
        ...
        outfile = open('sf3rus_'+str(imbalance_size)+'_' + pos_or_neg + '_results_run_'+str(p)+'.txt', 'w')
        dbfieldname = 'sf3rus_'+str(imbalance_size)+'_' + pos_or_neg + '_results_run_'+str(p)
        ...
        outfile.write("Negative before oversampling: {} \n".format(len(list_negative_instances)))
        outfile.write("Positive size befor oversampling: {} \n".format(len(list_positive_instances)))
        if len(list_positive_instances) < len(list_negative_instances):
            ...
            outfile.write("Negative after oversampling: {} \n".format(len(list_negative_balanced)))
            ...
            outfile.write("Positive size after oversampling: {} \n".format(len(list_positive_balanced)))
