...
for p in range(0,10):
    for t in range(0,4):
        ...
        outfile.write("Negative before undersampling now: {}\n".format(len(list_negative_instances)))
        outfile.write("Positive before undersampling now: {}\n".format(len(list_positive_instances)))
        ...
        if len(list_positive_instances) < len(list_negative_instances):
            ...
            outfile.write("Negative after undersampling now: {}\n".format(len(list_negative_balanced)))
            ...
            outfile.write("Positive after undersampling now: {}\n".format(len(list_positive_balanced)))
